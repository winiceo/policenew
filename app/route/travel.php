 ...
 * @apiParam {String} reason 出差原因.
 * @apiParam {String} address 出差地点.
 ...
 * "err_msg": "登录失败"
 * }
 * @apiSampleRequest /v1/travel/create
 */
 ...
 * "err_msg": "登录失败"
 * }
 * @apiSampleRequest /v1/travel/update
 */
 ...
 * "err_msg": "登录失败"
 * }
 * @apiSampleRequest /v1/travel/delete
 */
...
/**
 * @api {post} /travel/search 查询出差情况
 * @apiDescription 我的出差列表
 * @apiName listTravel
 * @apiGroup Travel出差
 * @apiHeader {String} Authorization 请求header部份增加Authorization 格式为 Bearer+空格+用户token.jwt的值.
 ...
 * "err_msg": "登录失败"
 * }
 * @apiSampleRequest /v1/travel/search
 */
...
//
    ...
    $plan->where_raw(sprintf("`type`='%s'",2));
